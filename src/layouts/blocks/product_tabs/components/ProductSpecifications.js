      ...
      <Col span={24} className="productSpecifications--sections">
        <div style={{ marginTop: 30 }}>
          ...
          <div id="description-section" style={{ marginTop: '2em' }}>
            ...
            nulla. Proin efficitur, nisi vel finibus elementum, orci sem volutpat
            eros, eget ultrices velit mi.
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium adipisci dicta, doloribus eaque fugit iusto maxime modi nulla pariatur rem sequi ullam, voluptatum. A alias architecto assumenda at aut autem deserunt dolorum eaque exercitationem explicabo facere fugit id in ipsa iure laboriosam nam natus neque nisi nobis non nulla quam qui, quis ratione repellat sint sit. Ab aliquid amet commodi ducimus ea fugit harum impedit incidunt inventore ipsa natus neque nesciunt nisi nostrum officia officiis omnis quae quia, quisquam rem repellat repellendus repudiandae sed unde velit vitae voluptates voluptatibus? Distinctio laborum natus quasi unde voluptatem, voluptatum! Ab accusantium ad animi assumenda, aut blanditiis consequatur, cupiditate dolorem eum fugiat fugit hic id impedit in incidunt inventore ipsam itaque iusto laboriosam maxime minus natus nulla odio quaerat quibusdam quidem quod quos reiciendis rem sit tempore, ut veritatis voluptates. Amet beatae, consectetur dignissimos dolore doloremque dolores ea eos est, et eveniet exercitationem explicabo id incidunt ipsum iure maiores minima molestias natus porro provident quaerat reiciendis reprehenderit saepe totam veritatis. Blanditiis commodi doloremque in, magni non sit! Earum eum excepturi harum laboriosam repellendus velit, veritatis voluptatibus! Aspernatur dolorem exercitationem fuga impedit iusto laborum libero nihil nisi quae quidem saepe sunt, totam unde voluptate voluptatum. Aperiam fugiat labore maxime modi nihil odio temporibus. A accusamus accusantium adipisci animi architecto aut consectetur dicta distinctio doloremque ducimus earum eius eligendi error et exercitationem hic incidunt ipsum iure iusto laboriosam maiores nemo nulla numquam obcaecati officiis optio pariatur possimus quae ratione reiciendis rerum sapiente sequi tempore tenetur vitae, voluptate voluptates? Architecto asperiores culpa, error modi quis quo sunt velit veritatis. Asperiores atque beatae blanditiis commodi culpa cupiditate doloribus ea eaque eligendi eum fugiat fugit ipsum iure molestiae mollitia, nihil nobis non perferendis porro quasi quia quos similique, tempore tenetur totam veritatis voluptates. Accusantium explicabo laudantium maiores quidem rem!
          </div>
